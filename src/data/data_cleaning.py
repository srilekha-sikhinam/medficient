...
df = pd.read_csv('Hospital_Inpatient_Discharges_17_18.csv')
...
df_exp.to_csv('Hospital_Inpatient_Discharges_17_18_cleaned.csv', index = False)
...
for i in illnesses:
    ...
    df_temp.to_csv('HID_cleaned_' + i.replace(' ', '') + '.csv', index = False)
