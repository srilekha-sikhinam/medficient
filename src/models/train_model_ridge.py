...
tt2 = TransformedTargetRegressor(regressor=Ridge(alpha = 1, fit_intercept = True), func=np.log, inverse_func=np.exp)
tt2.fit(X_test_all_features, y_test_all_features)

filename = 'models/finalized_length_of_stay_ridge_model'
