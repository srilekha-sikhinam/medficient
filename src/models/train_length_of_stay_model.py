...
def train_all_pop_model(best_params):
    ...
    if plat == 'Windows':
        filename = '\\all_pop_rf_model.pkl'
    elif plat =='Linux' or plat=='Darwin':
        filename = '//all_pop_rf_model.pkl'
    model = train_model(best_params, X_train, y_train, model_folder + filename)
...
def train_heart_patient_model(best_params):
    ...
    X, y, X_train, X_test, y_train, y_test = get_train_test_data(df)
    if plat == 'Windows':
        filename = '\\heart_patient_rf_model.pkl'
    elif plat =='Linux' or plat=='Darwin':
        filename = '//heart_patient_rf_model.pkl'
    model = train_model(best_params, X_train, y_train, model_folder + filename)
...
def train_knee_rep_patient_model(best_params):
    ...
    X, y, X_train, X_test, y_train, y_test = get_train_test_data(df)
    if plat == 'Windows':
        filename = '\\knee_rep_patient_rf_model.pkl'
    elif plat =='Linux' or plat=='Darwin':
        filename = '//knee_rep_patient_rf_model.pkl'
    model = train_model(best_params, X_train, y_train, model_folder + filename)
...
def train_kidney_patient_model(best_params):
    ...
    X, y, X_train, X_test, y_train, y_test = get_train_test_data(df)
    if plat == 'Windows':
        filename = '\\kidney_patient_rf_model.pkl'
    elif plat =='Linux' or plat=='Darwin':
        filename = '//kidney_patient_rf_model.pkl'
...
def train_schizophrenia_patient_model(best_params):
    ...
    X, y, X_train, X_test, y_train, y_test = get_train_test_data(df)
    if plat == 'Windows':
        filename = '\\schizophrenia_patient_rf_model.pkl'
    elif plat =='Linux' or plat=='Darwin':
        filename = '//schizophrenia_patient_rf_model.pkl'
    model = train_model(best_params, X_train, y_train, model_folder + filename)
...
def train_copd_patient_model(best_params):
    ...
    X, y, X_train, X_test, y_train, y_test = get_train_test_data(df)
    if plat == 'Windows':
        filename = '\\copd_patient_rf_model.pkl'
    elif plat =='Linux' or plat=='Darwin':
        filename = '//copd_patient_rf_model.pkl'
    model = train_model(best_params, X_train, y_train, model_folder + filename)
