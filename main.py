...
, 'Clinton', 'Chautauqua', 'Warren'], 
		...
		'APR Severity of Illness Code': apr_severity_of_illness_code_options,
...
if __name__ == "__main__":
	...
	apr_severity_of_illness_code_options = [1, 2, 3, 4]
 ...
 'Federal/State/Local/VA', 'Department of Corrections', 'Unknown']
	...
	clicked_apr_severity_of_illness_code = IntVar()
	clicked_apr_severity_of_illness_code.set( 1 )
